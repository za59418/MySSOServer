...
namespace MVCClient.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var url = "https://192.168.1.115:44319/identity/connect/authorize" +
                "?client_id=mvcClient" +
                "&response_type=id_token" +
                "&scope=openid" +
                "&redirect_uri=http://localhost/mvcClient/Home/SignInCallback" +
        ...
        private async Task<IEnumerable<Claim>> ValidateIdentityTokenAsync(string token, string state)
        {
            ...
            var parameters = new TokenValidationParameters
            {
                ...
                ValidIssuer = "https://192.168.1.115:44319/identity",
